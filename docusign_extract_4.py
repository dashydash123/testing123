...
def get_access_token():
    ...
    print("Access token obtained (valid ~8 hours). To reuse it without")
    print("rotating again, run with:\n")
    print(f'  set DS_ACCESS_TOKEN={data["access_token"][:40]}...\n')
    ...
    while True:
        data = api_get(
            ...
            params={
                ...
                # No status filter -- returns every user regardless of state.
                # DocuSign only accepts ActivationRequired, ActivationSent,
                # Active, Closed, Disabled here; anything else 400s.
            },
        )
